/**
 * Testing the browser version of NewDB
 * The goal of these tests is not to be exhaustive, we have the server-side NewDB tests for that
...
describe('Persistent in-browser database', function () {
  ...
  it('Create a localStorage-enabled database and insert to it, results are recorded in localStorage', function (done) {
    ...
    var d = new Newdb({ filename: 'test', autoload: true });
